  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (Capacitor.isNativePlatform()) {
        ...
        // Register push after successful login
        subscribeToPushNotifications(
          response.data.token
        );
      ...
      // useGoogleLogin handles the popup/redirect.
      // Loading will be reset in onSuccess/onError.
      googleLogin();
